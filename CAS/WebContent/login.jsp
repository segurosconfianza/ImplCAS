...
<html lang="en">
  ...
  <body>
	...
	<c:if test="${!empty param.login_cas_authentication}">	
			<div align="center">	
			<p/><img src="Imagenes/Iconos/candado_roto.jpg" width="40" height="40" ><span class="label label-danger">Error en la autenticacion del CAS</span>
			</div>
	</c:if>
	<c:if test="${!empty param.login_cas}">	
			<div align="center">	
			<p/><img src="Imagenes/Iconos/candado_roto.jpg" width="40" height="40" ><span class="label label-danger">Error en el CAS</span>
			</div>
	</c:if>
